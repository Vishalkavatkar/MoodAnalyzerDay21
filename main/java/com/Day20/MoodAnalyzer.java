...
public class MoodAnalyzer {
	 ...
	 * We have used the try & catch block to check if user enters null value.
	 * If null value found than the NullPointerException will be triggered & it will return Invalid Mood.
